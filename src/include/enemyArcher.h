...
class enemyArcher: public character {
    ...
    public:
        enemyArcher (const std::string& name, const stats& enemystats) : character(name, enemystats, {3, 6, 3, 2, 2}) {
        ...
        enemyArcher* clone () const override {
            return new enemyArcher(*this);
        }
};
